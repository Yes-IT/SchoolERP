        ...
        Route::group(['middleware' => ['lang', 'CheckSubscription', 'FeatureCheck:academic']], function () {
            ...
            Route::group(['middleware' => ['auth.routes', 'AdminPanel']], function () {
                 Route::controller(ClassesController::class)->prefix('classes')->group(function () {
                    ...
                    Route::post('/store',           'store')->name('classes.store')->middleware('PermissionCheck:classes_create');
                    Route::get('/edit/{id}',        'edit')->name('classes.edit')->middleware('PermissionCheck:classes_edit');
                    Route::put('/update/{id}', 'update')->name('classes.update')->middleware('PermissionCheck:classes_update');
                    ...
                    //for class info route
                    Route::get('/class-info/{id}',  'class_info')->name('classes.class_info')->middleware('PermissionCheck:classes_read');
                    Route::get('/filter', 'filter')->name('classes.filter')->middleware('PermissionCheck:classes_read');
                    Route::get('/subject/{id}',  'getSubjectJson')->name('classes.getSubjectJson')->middleware('PermissionCheck:classes_read');
