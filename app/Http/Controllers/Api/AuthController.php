...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        try {
            ...
            $user = User::where('email', $request->email)->select('id', 'name', 'email', 'phone', 'permissions', 'status', 'role_id', 'upload_id', 'uuid')->first();
            ...
            if (!in_array($user->role_id, [RoleEnum::STUDENT, RoleEnum::STAFF, RoleEnum::GUARDIAN, RoleEnum::TEACHER, RoleEnum::DRIVER()])) {
