...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        // Alumni Flow Management
        $this->app->bind(AlumniGalleryRepositoryInterface::class, AlumniGalleryRepository::class);
        $this->app->bind(RecordedClassRepositoryInterface::class, RecordedClassRepository::class);
