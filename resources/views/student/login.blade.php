                    ...
                    <div class="login-flow-left-wrp col-lg-6">
                        <div class="login-panel-outer">
                            ...
                            <div class="login-panel">
                                ...
                                <form id="login-form" method="post" action="{{route('student.login')}}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <div role="tablist" aria-label="Login type" class="tablist-container">
                                    <button role="tab" id="tab-student" aria-selected="true"
                                        aria-controls="panel-student" class="active" tabindex="0">
                                        <img src="{{asset('student/images/user-icon.svg')}}" alt="icon"> Student
                                    </button>
                                    <button role="tab" id="tab-parent" aria-selected="false"
                                        aria-controls="panel-parent" tabindex="-1">
                                        <img src="{{asset('student/images/multi-user-icon.svg')}}" alt="Icon"> Parent
                                    </button>
                                    <button role="tab" id="tab-alumni" aria-selected="false"
                                        aria-controls="panel-alumni" tabindex="-1">
                                        <img src="{{asset('student/images/alumni-icon.svg')}}" alt="Icon"> Alumni
                                    </button>
                                </div>
                                <p class="forgot-password">
                                    <a href="{{route('student.forget_password')}}">Forgot your password?</a>
                                </p>
                            </div>
                        </div>
                    </div>
