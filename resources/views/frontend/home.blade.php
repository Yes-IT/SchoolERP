                ...
                <div class="col-xl-7 col-lg-6 col-md-6">
                    <div class="statement_info mb_30">
                        ...
                        <ul class="statement_lists">
                            ...
                            {{-- @foreach ($sections['statement']->defaultTranslate->data ?? [] as $item) --}}
                            {{-- @dd($sections['statement']->defaultTranslate->data) --}}
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 col-md-6 mb_25">
                    ...
                    <div class="nav explorer_tabs" id="nav-tab" role="tablist">
                        ...
                        @foreach (is_array($sections['explore']->defaultTranslate->data) ? $sections['explore']->defaultTranslate->data : [] as $key => $item)
            ...
            <div class="row justify-content-center">
                <div class="col-xl-11">
                    <div class="teaching_grid mb_30">
                        ...
                        @foreach (is_array($sections['why_choose_us']->defaultTranslate->data) ? $sections['why_choose_us']->defaultTranslate->data : [] as $item)
