                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="ds-cmn-info-card">
                                    ...
                                    <div class="ds-cmn-ic-ftr">
                                      <a href="{{ route('fees-group.index') }}" class="cmn-btn w-100 btn-sm">View Details</a>
                            ...
                            <div class="col-lg-4">
                                <div class="ds-cmn-info-card">
                                    ...
                                    <div class="ds-cmn-ic-ftr">
                                        <a href="{{ route('fees-type.index') }}" class="cmn-btn w-100 btn-sm">View Details</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="ds-cmn-info-card">
                                    ...
                                    <div class="ds-cmn-ic-ftr">
                                        <a href="{{ route('fees-master.index') }}" class="cmn-btn w-100 btn-sm">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="ds-cmn-info-cards-wrp">
                        <div class="row mt-4">
                            <div class="col-lg-4">
                                <div class="ds-cmn-info-card">
                                    <div class="ds-cmn-ic-body">
                                        <h3>Assign Fees to students</h3>
                                        <p>Student profile,percent-info,class-assignments and teacher-data.</p>
                                    </div>
                                    <div class="ds-cmn-ic-ftr">
                                        <a href="{{ route('fees-assign.show') }}" class="cmn-btn w-100 btn-sm">View Details</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="ds-cmn-info-card">
                                    ...
                                    <div class="ds-cmn-ic-ftr">
                                        <a href="{{ route('fees-status.show') }}" class="cmn-btn w-100 btn-sm">View Details</a>
                                    </div>
                                </div>
                            </div>
