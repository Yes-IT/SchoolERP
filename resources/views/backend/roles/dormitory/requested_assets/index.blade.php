                            ...
                            <div class="sec-head">
                                <div class="ds-content-head">
                                    <div class="cmn-tab-head">
                                        <ul>
                                            <li class="tab-bg" style="left: 12px; top: 4px; width: 161.125px; height: 35px;"></li>
                                            <li class="active" onclick="switchTab(this)">Pending Request</li>
                                            <li onclick="switchTab(this)">Request Status</li>
                                        </ul>
                                    </div>
                            ...
                            <div class="btn-wrp align-items-start">
                                <div class="input-grp search-field mb-0">
                                    <div class="input-grp fees-type">
                                        <select id="assetTypeFilter" onchange="filterAssets()" style="width:81px;height:38px;">
                                            <option value="select-year">Filter</option>
                                            <option value="Monitor">Approved</option>
                                            <option value="Laptop">Rejected</option>
