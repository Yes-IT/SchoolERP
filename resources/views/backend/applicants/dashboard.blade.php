        ...
        <div class="dashboard-body dspr-body-outer">
            ...
            <div class="ds-breadcrumb">
                ...
                <ul>
                    ...
                    <li><a href="./dashboard">Student Application Forms</a> /</li>
                </ul>
            </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                  ...
                                  <td>Submitted</td>
                                  <td>
                                    <a href="#url" class="cmn-btn btn-sm"><img src="{{ asset('backend') }}/assets/images/new_images/calender-icon.svg" alt="Image"> Reschedule Interview</a>
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>Submitted</td>
                                    <td>
                                      <a href="./schedule-interview.html" class="cmn-btn btn-sm"><img src="{{ asset('backend') }}/assets/images/new_images/calender-icon.svg" alt="Image"> Schedule Interview</a>
                                    </td>
