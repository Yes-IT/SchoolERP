            ...
            <div class="ds-pr-body tab-wrapper">
                ...
                <div class="ds-cmn-table-wrp">
                    ...
                    <div class="cmn-tab-content online-mode">
                        ...
                        <div class="interview-location-row mt-4">
                            <label class="interview-location-label" for="interview-location">Meeting Link</label>
                            <input id="interview-location" class="interview-location-input" type="text" name="interview_location" placeholder="Meeting Link" />
                        
                            <div class="avaiable-slots-actions d-flex justify-content-end mt-3 gap-3">
                                <button type="button" class="cmn-btn cancel-btn">Cancel</button>
                                <button type="button" class="cmn-btn primary-assign-btn">Assign Slot</button>
                            </div>
                        </div>
                    </div>

                    <div class="cmn-tab-content offline-mode">
                        <div class="cmn-tab-content-head">
                            <h3>Available Slots</h3>
                            <button type="button">View Details</button>
                        </div>
