        ...
        <div class="ds-pr-body">
            <div class="ds-cmn-table-wrp">
                ...
                <div class="request-leave-form">
                    <form action="{{ route('notice-board.update', [$data['notice-board']->id]) }}" enctype="multipart/form-data" method="post" id="marksheet">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            <div class="col-lg-9">
                                    ...
                                    <div class="multi-input-grp">
                                        <div class="input-grp w-100">
                                            ...
                                            <input class="form-control ot-input @error('title') is-invalid @enderror" name="title"
                                                value="{{ old('title', $data['notice-board']->title) }}" list="datalistOptions"
                                                id="exampleDataList" placeholder="{{ ___('account.enter_title') }}">
                                            @error('title')
                                    ...
                                    <div class="multi-input-grp grp-2">
                                        <div class="input-grp">
                                            ...
                                            <input class="form-control ot-input @error('publish_date') is-invalid @enderror"
                                                ...
                                                value="{{ old('publish_date', $data['notice-board']->publish_date) }}">
                                            @error('publish_date')
                                                <div id="validationServer04Feedback" class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-5 classDiv d-none">
                                        ...
                                        <select id="getSections"
                                            ...
                                            @foreach ($data['classes'] as $item)
                                                <option
                                                    {{ old('class', @$data['notice-board']->class_id) == $item->id ? 'selected' : '' }}
                                    ...
                                    <div class="col-md-4 mb-5 sectionDiv d-none">
                                        ...
                                        <select
                                            ...
                                            <option value="{{ @$data['notice-board']->section_id }}" selected>
                                                {{ @$data['notice-board']->section_id ? $data['notice-board']->section->name : '' }}
                                            </option>
                                    ...
                                    <div class="col-md-4 mb-5 studentDiv d-none">
                                        ...
                                        <select
                                            ...
                                            <option value="{{ @$data['notice-board']->student_id ?? null }}" selected>
                                                {{ @$data['notice-board']->student_id ? $data['notice-board']->student->full_name : '' }}
                                            </option>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control ot-textarea @error('description') is-invalid @enderror" name="description"
                                            list="datalistOptions" id="summernote" placeholder="{{ ___('account.enter_description') }}">{{ old('description', $data['notice-board']->description) }}</textarea>
                                        @error('description')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="input-check-radio visbleSection @error('sections') is-invalid @enderror">
                                            @foreach ($data['roles'] as $item)
                                                <div>
                                                    <input type="checkbox" class="form-check-input visible-to-checkbox"
                                                        {{ $data['notice-board']->visible_to ? (in_array($item->id, $data['notice-board']->visible_to) ? 'checked' : '') : '' }}
                                                        name="visible_to[]" value="{{ $item->id }}" id="flexCheckDefault-{{ $item->id }}" />
