...
@section('content')
    ...
    <div class="atndnc-filter-form">
        <div class="atndnc-filter-options multi-input-grp">
            <div class="input-grp">
                <select id="ParentyearFilter" style="width:197px; position:relative; left:27px; top:11px;border-radius: 6px;"
                    onchange="toggleTabs()">
            ...
            <div class="ds-bdy-content w-100 align-items-start">
                ...
                <div class="ds-cmn-table-wrp request-transcript-pg tbl-btn-new" id="request-section">
                        ...
                        <div class="sec-head" id="tabSection">
                            <div class="ds-content-head">
                                <div class="cmn-tab-head">
                                    <ul>
                                        <li class="tab-bg" style="left: 12px; top: 4px; width: 161.125px; height: 35px;">
                                        </li>
                                ...
                                <div class="atndnc-filter-options multi-input-grp" style="gap:10px;">
                                    <div class="input-grp search-field mb-0">
                                        ...
                                        <input type="submit" value="Search"
                                            onclick="searchProcurePantry('procurementSearch','ProcurementBody');">
                                    </div>
                    ...
                    <div class="request-section">
                        @include('backend.dormitory.pantry_procurement.procurement-list', [
                            'requests' => $requests,
                        ])
                    </div>
                ...
                <div class="ds-cmn-table-wrp request-transcript-pg tbl-btn-new" id="approved-section" style="display:none;">
                    <div class="ds-content-head has-drpdn">
                        <div class="sec-head" id="tabSection">
                            <div class="ds-content-head">
                                <div class="sec-head">
                            ...
                            <div class="atndnc-filter-form">
                                <div class="atndnc-filter-options multi-input-grp" style="gap:10px;">
                                    <div class="input-grp search-field mb-0">
                                        ...
                                        <input type="submit" value="Search"
                                            onclick="searchProcurePantry('approved_req_search','approvedRequestBody');">
                                    </div>
                                    <div class="dsbdy-filter-wrp p-0 align-items-start">
                    ...
                    <div class="request-section">
                        @include('backend.dormitory.pantry_procurement.approved-request-list', [
                            'requests' => $requests,
                        ])
                    </div>
                ...
                <div class="dashboard-body dspr-body-outer" id="fullfillmentHistory-section" style="display: none;">
                                    ...
                                    <div class="atndnc-filter-options multi-input-grp">
                                        <div class="input-grp">
                                            <select id="userFilter"
                                                ...
                                                onchange="filterRequestsByUserPantry()">
                    ...
                    <div class="ds-cmn-table-wrp request-transcript-pg tbl-btn-new">
                        <div class="ds-content-head has-drpdn">
                            ...
                            <div class="filters">
                                <div class="atndnc-filter-form">
                                    <div class="atndnc-filter-options multi-input-grp" style="gap:10px;">
                                        <div class="input-grp search-field mb-0">
                                            <input type="text" placeholder="Search" id="fullfillment_req_search">
                                            <input type="submit" value="Search"
                                                onclick="searchProcurePantry('fullfillment_req_search','fullfillmentHistoryBody');">
                                        </div>
                                        <div class="dsbdy-filter-wrp p-0 align-items-start">
                        ...
                        <div class="request-section">
                            @include('backend.dormitory.pantry_procurement.fullfillment-history-list', [
                                'requests' => $requests,
                            ])
                        </div>
