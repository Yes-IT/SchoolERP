            ...
            <div class="atndnc-filter-wrp w-100">
                <div class="atndnc-filter-wrp w-100">
                    ...
                    <div class="atndnc-filter">
                        <form class="atndnc-filter-form" id="leave-filter-form">
    ...
    @push('script')
        <script>
            $(document).ready(function() {
                ...
                $('.dropdown-menu input[type="radio"]').on('change', function() {
                    const $dropdown = $(this).closest('.dropdown');
                    const $label = $dropdown.find('.dropdown-toggle .label');
                    const selectedText = $(this).parent().text().trim();

                    $label.text(selectedText || 'Select ' + $dropdown.find('.dropdown-toggle').attr('id').replace('toggle-', '').replace('-', ' '));
                });
