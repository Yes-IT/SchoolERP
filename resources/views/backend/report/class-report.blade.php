                ...
                <div class="w55 d-flex flex-column gap-4">
                    ...
                    <div class="dsbdy-cmn-card">
                        <div class="sec-head">
                            ...
                            <p class="muted-sm">Choose a class report</p>
                        </div>
                        <div class="request-leave-form-wrp student-report-filter-form-wrp">
                                ...
                                <fieldset class="request-leave-form student-report-filter-form" id="report-type-fieldset">
                                    <div class="multi-input-grp report-options">
                                        <div class="report-column p-3 w-100">
                                            <div class="input-grp">
                                                <label for="rpt-1"><input type="checkbox" name="report_type" value="student-parent"/> Blank Class Grade Sheet</label>
                                            </div>
                                            <div class="input-grp">
                                                <label for="rpt-2"><input type="checkbox" name="report_type" value="student-names-en"/> Class Grade Sheet with Grades Filled in</label>
                                            </div>
                                            <div class="input-grp">
                                                <label for="rpt-2"><input type="checkbox" name="report_type" value="student-names-en"/> Class Grade Sheet with Grades - Full Year</label>
                                            </div>
                                            <div class="input-grp">
                                                <label for="rpt-2"><input type="checkbox" name="report_type" value="student-names-en"/> Blank Class Grid Report</label>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                    ...
                    <div class="dsbdy-cmn-card output-options-card">
                        ...
                        <form class="request-leave-form output-options-filter" id="output-options-form" aria-labelledby="output-options-heading">
                            ...
                            <div class="input-grp mb-0">
                                <label for="state">Which Class(es) should be included?</label>
                            </div>

                            <div class="d-flex flex-column gap-3">
                                <div>
                                    <input type="radio" name="sort_order" value="student_name" checked>
                                    <label for="student_name">All Classes</label>
                                </div>
                                <div class="d-flex gap-1 align-content-start">
                                    ...
                                    <div class="w-100">
                                        <div><label for="student_name">Classes of one teacher:</label></div>
                                        <div>
                                            <select>
                                ...
                                <div class="d-flex gap-1 align-content-start">
                                    ...
                                    <div class="w-100">
                                        <div><label for="student_name">Specific Class(es):</label></div>
                                        <div>
                                            <select>
