            ...
            <ul>
                ...
                <li class="menu-item-has-children {{ request()->routeIs('alumni_flow.*') ? 'active' : '' }}">
                    <a href="{{route('alumni_flow.index')}}">
                        <img src="{{ asset('backend') }}/assets/images/new_images/superadmin-panel/sidebar-icon-6.svg" alt="Sidebar Icon">
                        Alumni 
                    </a>
                    <ul class="sub-menu">
                 ...
                 <li class="{{ request()->routeIs('grade_flow.*') ? 'active' : '' }}">
                    <a href="{{route('grade_flow.index')}}">
                        <img src="{{ asset('backend/assets/images/superadmin-panel/sidebar-icon-7.svg') }}" alt="Sidebar Icon">
                        Grade Flow
                    </a>
                </li>

                <li class="menu-item-has-children {{ request()->routeIs('leave.student.index','leave.student.data') ? 'active' : '' }}">
                    <a href="#">
                        <img src="{{ asset('backend/assets/images/new_images/superadmin-panel/sidebar-icon-8.svg') }}" alt="Sidebar Icon">
                        Leave 
                    </a>
                    <ul class="sub-menu">
                ...
                <li class="menu-item-has-children {{ request()->routeIs('transcript.index','transcript.college.index') ? 'active' : '' }}">
                    <a href="#">
                        <img src="{{ asset('backend/assets/images/new_images/superadmin-panel/sidebar-icon-8.svg') }}" alt="Sidebar Icon">
                        Transcript 
                    </a>
                ...
                <li class="{{ request()->routeIs('superadmin.subject.*') ? 'active' : '' }}">
                    <a href="{{ route('superadmin.subject.index') }}">
                        <img src="{{ asset('backend') }}/assets/images/new_images/superadmin-panel/sidebar-icon-9.svg" alt="Sidebar Icon">
                        Subject
                    </a>
                </li>
                ...
                <li>
                    <a href="#url">
                        <img src="{{ asset('backend') }}/assets/images/new_images/superadmin-panel/sidebar-icon-11.svg" alt="Sidebar Icon">
                        Assign Role
                    </a>
                </li>
                <li class="{{ request()->routeIs('assignment.*') ? 'active' : '' }}">
                    <a href="{{ route('assignment.index') }}">
                        <img src="{{ asset('backend') }}/assets/images/new_images/superadmin-panel/sidebar-icon-12.svg" alt="Sidebar Icon">
                        Assignment
                    </a>
                </li>
                ...
                <li class="{{ request()->routeIs('room_management.*') ? 'active' : '' }}">
                    <a href="{{ route('room_management.index') }}">
                        <img src="{{ asset('backend') }}/assets/images/new_images/superadmin-panel/sidebar-icon-13.svg" alt="Sidebar Icon">
                        Room
                    </a>
                </li>
                ...
                <li>
                    <a href="#url">
                        <img src="{{ asset('backend') }}/assets/images/new_images/superadmin-panel/sidebar-icon-14.svg" alt="Sidebar Icon">
                        Fees
                    </a>
                </li>
                <li class="{{ request()->routeIs('exam-schedule.*') ? 'active' : '' }}">
                    <a href="{{ route('exam-schedule.index') }}">
                        <img src="{{ asset('backend/assets/images/superadmin-panel/sidebar-icon-13.svg') }}" alt="Sidebar Icon">
                        Exam Schedule
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="#url">
                        <img src="{{ asset('backend') }}/assets/images/new_images/superadmin-panel/sidebar-icon-17.svg" alt="Sidebar Icon">
                        Dormitory
                    </a>
                </li>
                <li>
                    <a href="#url">
                        <img src="{{ asset('backend') }}/assets/images/new_images/superadmin-panel/sidebar-icon-18.svg" alt="Sidebar Icon">
                        Notice Board
                    </a>
                </li>
                <li>
