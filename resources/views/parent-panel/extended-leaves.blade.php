                                    ...
                                    <h2>Leaves
                                        <div class="ibtn">
                                                        <button type="button" class="ibtn-icon">
                                                            <img src="../images/i-icon.svg" class="eyebtn" alt="Icon">
                                                        </button>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="actions-wrp">
                                                    <button type="button" data-bs-toggle="modal" data-bs-target="#editLeaveRequest"><img src="{{ asset('parent/images/edit-icon-primary.svg') }}" alt="Icon"></button>
                                                    <button type="button" data-bs-toggle="modal" data-bs-target="#deleteLeaveRequest"><img src="{{ asset('parent/images/bin-icon.svg') }}"  alt="Icon"></button>
                                                </div>
                                            </td>
                                        </tr>
